...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().runtime.onInstalled.addListener(() => {
    ...
    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().contextMenus.create({
        id: 'readAloud',
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().contextMenus.onClicked.addListener((info, tab) => {
    ...
    else if (info.menuItemId === 'readFromHere' && info.selectionText && (tab === null || tab === void 0 ? void 0 : tab.id) !== undefined) {
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().commands.onCommand.addListener((command) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const tabs = yield webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().tabs.query({ active: true, currentWindow: true });
    const tab = tabs[0];
    ...
    switch (command) {
        case 'read-selection':
            ...
            try {
                const results = yield webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().scripting.executeScript({
                    target: { tabId: tab.id },
        ...
        case 'read-from-here':
            ...
            try {
                ...
                const selectedText = (_b = results[0]) === null || _b === void 0 ? void 0 : _b.result;
                if (selectedText && selectedText.trim()) {
                    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().tabs.sendMessage(tab.id, {
                        action: 'readFromHere',
                        text: selectedText,
